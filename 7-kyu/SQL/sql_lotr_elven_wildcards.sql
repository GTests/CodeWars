...
-- After much thought you decide to select candidates by name, which are often closely aligned to an elf's skill and temperament.
...
-- Did a lot of research on PostgreSQL string functions
-- Tried substring() and length(). Could not get it to work
