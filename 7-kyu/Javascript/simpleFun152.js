...
/**
 * Checks if men and women count is the same
 *
 * @param {Array} people is an array of -1 or 1 numbers
 * 
 * @returns boolean value 
 */
function inviteMoreWomen(people) {
  const result = people.reduce((accumulator, currentValue) => accumulator + currentValue, 0);
  return result > 0;
}
